...
if (missingItems.length > 0) {
    ...
    missingItems.forEach(item => {
        let texture = fetch(`https://raw.githubusercontent.com/vopswtf/Vops-Capes/main/api/assets/items/${item}/texture.png`).buffer();
        let model = fetch(`https://raw.githubusercontent.com/vopswtf/Vops-Capes/main/api/assets/items/${item}/model.cfg`).buffer();
